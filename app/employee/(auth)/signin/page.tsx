  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6 bg-[#FAF8F5]">
      <div className="w-full max-w-sm flex flex-col items-center">
        ...
        {/* Floating card */}
        <div className="w-full bg-white rounded-3xl px-8 pt-12 pb-8 shadow-[0_4px_12px_rgba(20,20,20,0.08),0_1px_3px_rgba(20,20,20,0.06)] flex flex-col items-center gap-6">
          {/* Title */}
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-gray-500 font-techstack">
              Submit requests, track their status, and stay updated with office announcements
            </p>
          </div>
          ...
          <Button
            ...
            disabled={loading}
            className="w-full h-12 text-base font-grotesk font-normal bg-[#141414] hover:bg-black text-white rounded-xl cursor-pointer transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(20,20,20,0.12),0_2px_6px_rgba(20,20,20,0.08)] disabled:translate-y-0 disabled:shadow-none"
