      ...
      <div className="flex-1 pb-8 flex flex-col gap-4 px-4 pt-4">
        ...
        <div className="bg-white rounded-2xl p-4">
          ...
          <div className="flex items-center gap-4 pt-3 border-t border-gray-100">
            <div>
              <p className="text-[10px] uppercase tracking-wide text-gray-400 font-semibold">Пріоритет</p>
              <p className="text-sm font-medium text-gray-800 mt-0.5">
                {PRIORITY_LABEL[request.priority] ?? request.priority}
              </p>
            </div>
            <div>
              <p className="text-[10px] uppercase tracking-wide text-gray-400 font-semibold">Оновлено</p>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            <div className="bg-white rounded-xl px-4 py-3 border-l-4 border-blue-200">
              <p className="text-sm font-medium text-gray-900">Ви створили запит</p>
              <p className="text-xs text-gray-400 mt-0.5">{formatDateTime(request.createdAt)}</p>
            </div>
            {request.status !== "new" && (
              <div className="bg-white rounded-xl px-4 py-3 border-l-4 border-blue-200">
                <p className="text-sm font-medium text-gray-900">
                  Статус змінено на «{statusConf.label}»
                </p>
