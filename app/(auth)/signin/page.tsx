  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await signIn.email(
      { email, password },
      {
        ...
        onError: (ctx) => { setError(ctx.error.message || "Sign in failed"); setLoading(false); },
      }
    );
  };
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-md bg-white/65 backdrop-blur-md rounded-3xl p-8 shadow-[0_8px_40px_rgba(249,115,22,0.12),0_1px_4px_rgba(20,20,20,0.05)] border border-white/50">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 font-techstack">Welcome back. Please enter your login details below</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label htmlFor="email" className="block text-xs font-grotesk text-gray-500 uppercase tracking-widest">
                Email address
              </label>
              <Input
                id="email"
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <label htmlFor="password" className="block text-xs font-grotesk text-gray-500 uppercase tracking-widest">
                  Password
                </label>
                <Link href="/forgot-password" className="text-xs font-techstack text-gray-400 hover:text-amber-600 transition">
                  Forgot password?
                </Link>
              </div>
              <Input
            ...
            <div className="relative my-2">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-white/30 backdrop-blur-sm rounded-full text-gray-400 font-techstack">Or continue with</span>
              </div>
            </div>
          ...
          <p className="text-center text-sm font-techstack text-gray-500 mt-8">
            ...
            <Link href="/signup" className="text-amber-600 hover:text-amber-700 font-grotesk transition" data-testid="signin-signup-link">
              Sign up here
            </Link>
          </p>
        </div>
