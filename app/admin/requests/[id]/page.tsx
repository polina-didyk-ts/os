  ...
  return (
    <div className="flex items-center gap-0">
      {STEPPER_STEPS.map((step, idx) => {
        const isDone =
          idx < currentIdx || (idx === currentIdx && !isRejected && status === "completed");
          ...
          <div key={step.status} className="flex items-center">
            ...
            <div className="flex flex-col items-center gap-1">
              <div
                ...
                style={
                  filled ? { background: "linear-gradient(135deg, #fbbf24 0%, #f97316 100%)" } : {}
                }
              >
                {filled ? (
              ...
              <span
                className={`text-[10px] font-grotesk ${filled ? "text-amber-600" : "text-gray-400"}`}
              >
                {step.label}
              </span>
            </div>
  ...
  return (
    <div className="flex flex-col gap-2">
      {events.map((e, i) => (
        <div
          key={i}
          className="bg-white/60 backdrop-blur-sm rounded-xl px-4 py-3 border-l-4 border-amber-400/60 border border-white/40 shadow-[0_2px_8px_rgba(20,20,20,0.06)]"
        >
      ...
      <div className="flex-1 pb-8 flex flex-col gap-4 px-4 pt-4">
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 shadow-[0_4px_12px_rgba(20,20,20,0.06),0_1px_3px_rgba(20,20,20,0.04)] border border-white/40">
          <div className="flex items-start justify-between gap-3 mb-4">
            ...
            <div
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg ${priorityConf.bgClass} border border-white/40 shrink-0`}
            >
